package loader.model.interfaces;
...
public interface GameLoader {  // load all players from a file and return them as a Collection<Player>  
	...
	public abstract void saveAllPlayers (String path, Collection<Player>  players) 
			throws GameLoaderException; 
